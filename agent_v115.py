...
def trigger(parameter, idTR, isLast=0):
        """ 
        (str, int, int) -> ()
        Dynamically load a module that its file path is known.
        ...
        try:
            cursor.execute( "INSERT INTO TriggeringCondition(Parameters ,idTaskResource, isLast, Status) VALUES (%s, %d, %d, 0)"%(parameter, idTR, isLast))
